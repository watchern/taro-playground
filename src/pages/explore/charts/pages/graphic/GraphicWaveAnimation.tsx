...
export default function GraphicWaveAnimation() {
  ...
  useEffect(() => {
    ...
    if (svgRef.current) {
      ...
      function createElements() {
        ...
        for (let x = 20; x < chart.getWidth(); x += 40) {
          for (let y = 20; y < chart.getHeight(); y += 40) {
  ...
  return (
    <View>
      <View className="header">Wave Animation</View>
      <View className="body">
